...
c     then recompute base flow solution corresponding to unit forcing:
   ...
   20    continue
      ...
      call unprojenrich() ! SRB - reconstruct flow solution to include enrichment when computing domain integral
      ...
      call projenrich() !SRB - switch back to enriched formulation
